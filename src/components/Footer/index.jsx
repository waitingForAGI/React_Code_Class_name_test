...
export default function Footer({ ...props }) {
  return (
    <footer {...props} className={`${props.className} flex items-center py-[72px] md:py-5 bg-white`}>
      <div className="container-xs mt-1.5 flex justify-center md:px-5">
        <div className="flex w-[96%] flex-col items-start gap-28 md:w-full md:gap-[84px] sm:gap-14">
          <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
            <div className="flex w-[42%] items-center justify-center md:w-full sm:flex-col">
              <div className="flex flex-1 flex-col gap-[42px] sm:self-stretch">
                <div className="flex items-start gap-[11px]">
                  <Img
                    ...
                    alt="Realestateone"
                    className="h-[40px] w-[40px] self-center"
                  />
                ...
                <div className="flex flex-col gap-7">
                  <Heading as="p" className="text-[16px] font-semibold leading-[160%] text-darkslategray">
                    <>
              ...
              <div className="flex w-[30%] flex-col items-start gap-3.5 sm:w-full">
                <Heading size="headinglg" as="p" className="text-[18px] font-bold text-darkslategray">
                  Features
                </Heading>
